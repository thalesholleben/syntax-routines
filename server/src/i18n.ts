...
const pt = {
  ...
  mailFailSecret: "O Windows não conseguiu cifrar ou abrir a senha salva. Configure o e-mail de novo.",
...
const en: Messages = {
  ...
  mailFailSecret: "Windows could not encrypt or open the saved password. Configure the e-mail again.",
