...
const pt = {
  ...
  smtpNotConfiguredEnv: "SMTP não configurado: defina MAIL_FROM_EMAIL, SMTP_USER e SMTP_PASS no .env.",
  smtpRejected: (detail: string) => `SMTP recusou o envio: ${detail}`,
...
const en: Messages = {
  ...
  smtpNotConfiguredEnv: "SMTP is not configured: set MAIL_FROM_EMAIL, SMTP_USER and SMTP_PASS in .env.",
  smtpRejected: (detail: string) => `SMTP rejected the message: ${detail}`,
