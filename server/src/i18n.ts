...
const pt = {
  ...
  notifyEmailMissing: "Configure o e-mail que recebe os avisos antes de testar.",
  mailNotConfigured: "E-mail de envio não configurado: abra Configurar e-mail em Ajustes.",
  mailFailAuth: "O servidor recusou o e-mail ou a senha. No Gmail, use uma senha de app, não a senha da conta.",
  mailFailConnection: "Não foi possível conectar ao servidor. Confira o endereço, a porta e a internet.",
  mailFailNotFound: "Servidor de e-mail não encontrado. Confira o endereço e a internet.",
  mailFailTls: "A conexão segura com o servidor falhou. Confira a porta: 465 para SSL, 587 para STARTTLS.",
  mailFailRejected: "O servidor recusou a mensagem. Confira o e-mail que envia e o que recebe.",
  mailFailSecret: "O cofre de senhas do sistema não conseguiu guardar ou abrir a senha salva. Configure o e-mail de novo.",
  mailFailOther: "O servidor de e-mail respondeu com erro.",
  mailFailDetail: (text: string, detail: string) => `${text} Detalhe: ${detail}`,
  ...
  mailHostInvalid: "Servidor SMTP inválido.",
  mailPortInvalid: "Porta inválida: use um número de 1 a 65535.",
  mailFromInvalid: "E-mail que envia inválido.",
  mailPasswordRequired: "Digite a senha.",
...
const en: Messages = {
  ...
  notifyEmailMissing: "Set the e-mail that receives the alerts before testing.",
  mailNotConfigured: "Sending e-mail is not configured: open Configure e-mail in Settings.",
  mailFailAuth: "The server rejected the e-mail or the password. On Gmail, use an app password, not the account password.",
  mailFailConnection: "Could not connect to the server. Check the address, the port and the internet connection.",
  mailFailNotFound: "E-mail server not found. Check the address and the internet connection.",
  mailFailTls: "The secure connection to the server failed. Check the port: 465 for SSL, 587 for STARTTLS.",
  mailFailRejected: "The server refused the message. Check the sender and the recipient e-mails.",
  mailFailSecret: "The system password vault could not store or open the saved password. Configure the e-mail again.",
  mailFailOther: "The e-mail server answered with an error.",
  mailFailDetail: (text: string, detail: string) => `${text} Detail: ${detail}`,
  ...
  mailHostInvalid: "Invalid SMTP server.",
  mailPortInvalid: "Invalid port: use a number from 1 to 65535.",
  mailFromInvalid: "Invalid sender e-mail.",
  mailPasswordRequired: "Enter the password.",
